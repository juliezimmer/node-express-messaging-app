...
app.get('/messages/:user', (req,res) => {
  //this gives access to the user parameter
...
app.post('/messages', async (req,res) => {
  try {
    ...
    } finally {//most cases won't require or need a finally block
        console.log("message post was called")

    }
  })

/*This is the callback function that checks for other user connections.
